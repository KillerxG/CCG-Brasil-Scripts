...
function s.initial_effect(c)
	--Enkyo Summon
	Idrakian.AddProcedure(c,4,aux.FilterBoolFunctionEx(Card.IsSetCard,0x309),aux.FilterBoolFunctionEx(Card.IsSetCard,0x309))
	c:AddSetcodesRule(id,true,0x314)--Waifu Arch
	c:AddSetcodesRule(id,true,0x309)--Rockslash Arch
