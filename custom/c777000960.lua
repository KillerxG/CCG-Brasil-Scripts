...
function s.initial_effect(c)
	----Enkyo Summon
	Idrakian.AddProcedure(c,4,aux.FilterBoolFunctionEx(Card.IsSetCard,0x302),aux.FilterBoolFunctionEx(Card.IsSetCard,0x302))
	c:AddSetcodesRule(id,true,0x314a)--Husband Arch
	c:AddSetcodesRule(id,true,0x302)--Phantom Gunners Arch
	Card.Alias(c,id)
