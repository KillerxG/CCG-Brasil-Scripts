...
--(2)Metaverse "Shinigami Lands"Lands"
function s.filter(c,tp)
	return c:IsCode(777002140) and (c:IsAbleToHand() or c:GetActivateEffect():IsActivatable(tp,true,true))
end
