...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--(2)Apply the effects of a "Fusion/Polymerization" spell
...
function s.lcheck(g,lc,sumtype,tp)
	return g:IsExists(Card.IsSetCard,1,nil,0x10f3,lc,sumtype,tp)
end
--(1)Change attribute to DARK
...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.copfilter,tp,LOCATION_DECK,0,1,nil) and Duel.IsExistingMatchingCard(s.drfilter,tp,LOCATION_HAND,0,1,nil) end
