...
function s.initial_effect(c)
    c:EnableReviveLimit()
    Idrakian.AddProcedure(c,3,aux.FilterBoolFunctionEx(Card.IsSetCard,0x311),aux.FilterBoolFunctionEx(Card.IsSetCard,0x311))
	c:AddSetcodesRule(id,true,0x314a)--Husband Arch
	c:AddSetcodesRule(id,true,0x311)
...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_IDRAKIAN)
end
