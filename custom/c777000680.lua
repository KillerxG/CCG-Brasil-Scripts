...
function s.initial_effect(c)
	--Enkyo Summon
	Idrakian.AddProcedure(c,4,aux.FilterBoolFunctionEx(Card.IsSetCard,0x300),aux.FilterBoolFunctionEx(Card.IsSetCard,0x300))
	c:AddSetcodesRule(id,true,0x314a)--Husband Arch
	c:AddSetcodesRule(id,true,0x300)--Draconic Arch
