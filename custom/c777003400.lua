...
function s.thfilter(c,lv)
	return c:IsMonster() and c:IsSetCard(lv) and c:IsAbleToHand()
end
function s.revfilter(c,tp)
	return c:IsMonster() and not c:IsPublic()
		and Duel.IsExistingMatchingCard(s.thfilter,tp,LOCATION_DECK,0,1,nil,c:GetSetCard())
end
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g2=Duel.SelectMatchingCard(tp,s.thfilter,tp,LOCATION_DECK,0,1,1,nil,g1:GetFirst():GetSetCard())
