...
function s.initial_effect(c)
	c:AddSetcodesRule(id,true,0xea)--Crystron Arch
	Card.Alias(c,id)
	--Must be properly summoned before reviving
	c:EnableReviveLimit()
	--Link Summon procedure
	Link.AddProcedure(c,nil,2,2,s.lcheck)
	--(1)Special Summon 1 Level 3 or lower Tuner monster from your Deck
	...
	c:RegisterEffect(e1)
	--(2)Special Summon 1 Synchro Tuner monster from your Extra Deck
...
function s.lcheck(g,lc,sumtype,tp)
	return g:IsExists(Card.IsSetCard,1,nil,0xea,lc,sumtype,tp)
end
--(1)Special Summon 1 Level 3 or lower Tuner monster from your Deck
