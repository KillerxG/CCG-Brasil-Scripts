...
function s.initial_effect(c)
	--Enkyo Summon
	Idrakian.AddProcedure(c,4,aux.FilterBoolFunctionEx(Card.IsSetCard,0x301),aux.FilterBoolFunctionEx(Card.IsSetCard,0x301))
	c:AddSetcodesRule(id,true,0x314a)--Husband Arch
	c:AddSetcodesRule(id,true,0x301)--Thunder Force Arch
