...
function s.setfilter(c)
	return c:IsSetCard(0x298) and (c:IsSpell() or c:IsTrap()) and c:IsSSetable()
end
...
function s.tdfilter(c)
    return c:IsSetCard(0x298) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsAbleToDeck()
end
