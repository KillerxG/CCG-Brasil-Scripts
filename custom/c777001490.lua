...
function s.initial_effect(c)
	--Enkyo Summon
	Idrakian.AddProcedure(c,3,aux.FilterBoolFunctionEx(Card.IsSetCard,0x306),aux.FilterBoolFunctionEx(Card.IsSetCard,0x306))
	c:AddSetcodesRule(id,true,0x314)--Waifu Arch
	c:AddSetcodesRule(id,true,0x306)--Sky Wind Arch
