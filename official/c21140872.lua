...
function s.initial_effect(c)
	c:AddSetcodesRule(id,true,0x3b)--Red-Eyes Arch
	Card.Alias(c,id)
	--fusion material
	c:EnableReviveLimit()
...
function s.eqfilter(c,tp)
	return (c:IsRace(RACE_DRAGON) or c:IsSetCard(0x3b)) and c:CheckUniqueOnField(tp) and c:IsMonster() and not c:IsForbidden()
end
