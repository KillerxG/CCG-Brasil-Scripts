...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x3b) and c:IsLevelBelow(7) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.tdfilter(c)
	return c:IsSetCard(0x3b) and c:IsLevelBelow(7) and not c:IsCode(id) and c:IsAbleToDeck()
end
